...
NOTE: This project has been abandonded for the time being. Without control over directing transaction fees or MEV into the validator balance, it becomes possible that proposing blocks has greater value to the operator than the operator's initial stake. It's unclear at this time if there is a stake high enough to offset this, if more operator value will ever be directed into the validator balance, or if the goals of this project will be better served by means outside of smart contracts.
